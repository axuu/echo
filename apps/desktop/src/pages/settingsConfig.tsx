...
export type SettingsCategory = "video" | "transcription" | "generation" | "knowledge" | "files" | "performance" | "prompts" | "runtime" | "updates" | "logs";
...
export const settingsCategories: Array<{
  ...
  { id: "performance", label: "性能与资源", description: "并发数、重试和资源分配。", group: "system", icon: <SlidersIcon /> },
