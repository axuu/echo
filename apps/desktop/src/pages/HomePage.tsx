...
import { formatDuration, loadHiddenPromptPresetIds, PROMPT_PRESETS_VISIBILITY_EVENT } from "../utils";
...
const PREFERENCE_HINT_SEEN_KEY = "echo.summaryPreferenceHintSeen";
const PROMPT_PRESET_STORAGE_KEY = "echo.promptPresetId";
...
export function HomePage({
  ...
  useEffect(() => {
    ...
    window.addEventListener(PROMPT_PRESETS_VISIBILITY_EVENT, handlePromptVisibilityChanged);
    window.addEventListener("storage", handlePromptVisibilityChanged);
    return () => {
      window.removeEventListener(PROMPT_PRESETS_VISIBILITY_EVENT, handlePromptVisibilityChanged);
  ...
  useEffect(() => {
    ...
    window.addEventListener("echo:desktop-file-drop", handleDesktopFileDrop);
    return () => {
      ...
      window.removeEventListener("echo:desktop-file-drop", handleDesktopFileDrop);
    };
